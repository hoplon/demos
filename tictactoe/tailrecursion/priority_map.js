...
tailrecursion.priority_map.PersistentPriorityMap.cljs$lang$ctorPrWriter = (function (this__8377__auto__,writer__8378__auto__,opt__8379__auto__){return cljs.core._write(writer__8378__auto__,"tailrecursion.priority-map/PersistentPriorityMap");
});
tailrecursion.priority_map.PersistentPriorityMap.prototype.cljs$core$IHash$_hash$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var h__8221__auto__ = self__.__hash;if(!((h__8221__auto__ == null)))
{return h__8221__auto__;
} else
{var h__8221__auto____$1 = cljs.core.hash_imap(this$__$1);self__.__hash = h__8221__auto____$1;
...
var G__10610 = null;
var G__10610__2 = (function (self__,item){var self__ = this;
var self____$1 = this;var this$ = self____$1;return this$.cljs$core$ILookup$_lookup$arity$2(null,item);
});
var G__10610__3 = (function (self__,item,not_found){var self__ = this;
var self____$1 = this;var this$ = self____$1;return this$.cljs$core$ILookup$_lookup$arity$3(null,item,not_found);
});
G__10610 = function(self__,item,not_found){
switch(arguments.length){
case 2:
return G__10610__2.call(this,self__,item);
case 3:
return G__10610__3.call(this,self__,item,not_found);
}
...
;
tailrecursion.priority_map.PersistentPriorityMap.prototype.apply = (function (self__,args10585){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args10585)));
});
...
var coll__$1 = this;return cljs.core.seq((function (){var iter__8535__auto__ = ((function (coll__$1){
return (function iter__10586(s__10587){return (new cljs.core.LazySeq(null,((function (coll__$1){
return (function (){var s__10587__$1 = s__10587;while(true){
var temp__4092__auto__ = cljs.core.seq(s__10587__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var vec__10593 = cljs.core.first(xs__4579__auto__);var priority = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10593,0,null);var item_set = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10593,1,null);var iterys__8531__auto__ = ((function (s__10587__$1,vec__10593,priority,item_set,xs__4579__auto__,temp__4092__auto__,coll__$1){
return (function iter__10588(s__10589){return (new cljs.core.LazySeq(null,((function (s__10587__$1,vec__10593,priority,item_set,xs__4579__auto__,temp__4092__auto__,coll__$1){
return (function (){var s__10589__$1 = s__10589;while(true){
var temp__4092__auto____$1 = cljs.core.seq(s__10589__$1);if(temp__4092__auto____$1)
{var s__10589__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_(s__10589__$2))
{var c__8533__auto__ = cljs.core.chunk_first(s__10589__$2);var size__8534__auto__ = cljs.core.count(c__8533__auto__);var b__10591 = cljs.core.chunk_buffer(size__8534__auto__);if((function (){var i__10590 = 0;while(true){
if((i__10590 < size__8534__auto__))
{var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8533__auto__,i__10590);cljs.core.chunk_append(b__10591,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null));
{
var G__10611 = (i__10590 + 1);
i__10590 = G__10611;
continue;
}
} else
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__10591),iter__10588(cljs.core.chunk_rest(s__10589__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__10591),null);
}
} else
{var item = cljs.core.first(s__10589__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null),iter__10588(cljs.core.rest(s__10589__$2)));
}
} else
{return null;
}
...
});})(s__10587__$1,vec__10593,priority,item_set,xs__4579__auto__,temp__4092__auto__,coll__$1))
,null,null));
});})(s__10587__$1,vec__10593,priority,item_set,xs__4579__auto__,temp__4092__auto__,coll__$1))
;var fs__8532__auto__ = cljs.core.seq(iterys__8531__auto__(item_set));if(fs__8532__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__8532__auto__,iter__10586(cljs.core.rest(s__10587__$1)));
} else
{{
var G__10612 = cljs.core.rest(s__10587__$1);
s__10587__$1 = G__10612;
continue;
}
}
} else
...
;return iter__8535__auto__(cljs.core.rseq(self__.priority__GT_set_of_items));
})());
});
...
var this$__$1 = this;var sets = (cljs.core.truth_(ascending_QMARK_)?cljs.core.subseq.cljs$core$IFn$_invoke$arity$3(self__.priority__GT_set_of_items,cljs.core._GT__EQ_,k):cljs.core.rsubseq.cljs$core$IFn$_invoke$arity$3(self__.priority__GT_set_of_items,cljs.core._LT__EQ_,k));return cljs.core.seq((function (){var iter__8535__auto__ = ((function (sets,this$__$1){
return (function iter__10594(s__10595){return (new cljs.core.LazySeq(null,((function (sets,this$__$1){
return (function (){var s__10595__$1 = s__10595;while(true){
var temp__4092__auto__ = cljs.core.seq(s__10595__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var vec__10601 = cljs.core.first(xs__4579__auto__);var priority = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10601,0,null);var item_set = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10601,1,null);var iterys__8531__auto__ = ((function (s__10595__$1,vec__10601,priority,item_set,xs__4579__auto__,temp__4092__auto__,sets,this$__$1){
return (function iter__10596(s__10597){return (new cljs.core.LazySeq(null,((function (s__10595__$1,vec__10601,priority,item_set,xs__4579__auto__,temp__4092__auto__,sets,this$__$1){
return (function (){var s__10597__$1 = s__10597;while(true){
var temp__4092__auto____$1 = cljs.core.seq(s__10597__$1);if(temp__4092__auto____$1)
{var s__10597__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_(s__10597__$2))
{var c__8533__auto__ = cljs.core.chunk_first(s__10597__$2);var size__8534__auto__ = cljs.core.count(c__8533__auto__);var b__10599 = cljs.core.chunk_buffer(size__8534__auto__);if((function (){var i__10598 = 0;while(true){
if((i__10598 < size__8534__auto__))
{var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8533__auto__,i__10598);cljs.core.chunk_append(b__10599,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null));
{
var G__10613 = (i__10598 + 1);
i__10598 = G__10613;
continue;
}
} else
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__10599),iter__10596(cljs.core.chunk_rest(s__10597__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__10599),null);
}
} else
{var item = cljs.core.first(s__10597__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null),iter__10596(cljs.core.rest(s__10597__$2)));
}
} else
{return null;
}
...
});})(s__10595__$1,vec__10601,priority,item_set,xs__4579__auto__,temp__4092__auto__,sets,this$__$1))
,null,null));
});})(s__10595__$1,vec__10601,priority,item_set,xs__4579__auto__,temp__4092__auto__,sets,this$__$1))
;var fs__8532__auto__ = cljs.core.seq(iterys__8531__auto__(item_set));if(fs__8532__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__8532__auto__,iter__10594(cljs.core.rest(s__10595__$1)));
} else
{{
var G__10614 = cljs.core.rest(s__10595__$1);
s__10595__$1 = G__10614;
continue;
}
}
} else
...
;return iter__8535__auto__(sets);
})());
});
...
var this$__$1 = this;return cljs.core.seq((function (){var iter__8535__auto__ = ((function (this$__$1){
return (function iter__10602(s__10603){return (new cljs.core.LazySeq(null,((function (this$__$1){
return (function (){var s__10603__$1 = s__10603;while(true){
var temp__4092__auto__ = cljs.core.seq(s__10603__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var vec__10609 = cljs.core.first(xs__4579__auto__);var priority = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10609,0,null);var item_set = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10609,1,null);var iterys__8531__auto__ = ((function (s__10603__$1,vec__10609,priority,item_set,xs__4579__auto__,temp__4092__auto__,this$__$1){
return (function iter__10604(s__10605){return (new cljs.core.LazySeq(null,((function (s__10603__$1,vec__10609,priority,item_set,xs__4579__auto__,temp__4092__auto__,this$__$1){
return (function (){var s__10605__$1 = s__10605;while(true){
var temp__4092__auto____$1 = cljs.core.seq(s__10605__$1);if(temp__4092__auto____$1)
{var s__10605__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_(s__10605__$2))
{var c__8533__auto__ = cljs.core.chunk_first(s__10605__$2);var size__8534__auto__ = cljs.core.count(c__8533__auto__);var b__10607 = cljs.core.chunk_buffer(size__8534__auto__);if((function (){var i__10606 = 0;while(true){
if((i__10606 < size__8534__auto__))
{var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8533__auto__,i__10606);cljs.core.chunk_append(b__10607,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null));
{
var G__10615 = (i__10606 + 1);
i__10606 = G__10615;
continue;
}
} else
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__10607),iter__10604(cljs.core.chunk_rest(s__10605__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__10607),null);
}
} else
{var item = cljs.core.first(s__10605__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,priority], null),iter__10604(cljs.core.rest(s__10605__$2)));
}
} else
{return null;
}
...
});})(s__10603__$1,vec__10609,priority,item_set,xs__4579__auto__,temp__4092__auto__,this$__$1))
,null,null));
});})(s__10603__$1,vec__10609,priority,item_set,xs__4579__auto__,temp__4092__auto__,this$__$1))
;var fs__8532__auto__ = cljs.core.seq(iterys__8531__auto__(item_set));if(fs__8532__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__8532__auto__,iter__10602(cljs.core.rest(s__10603__$1)));
} else
{{
var G__10616 = cljs.core.rest(s__10603__$1);
s__10603__$1 = G__10616;
continue;
}
}
} else
...
;return iter__8535__auto__(self__.priority__GT_set_of_items);
})());
});
...
if(in$)
{{
var G__10617 = cljs.core.nnext(in$);
var G__10618 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(out,cljs.core.first(in$),cljs.core.second(in$));
in$ = G__10617;
out = G__10618;
continue;
}
...
priority_map.cljs$lang$applyTo = (function (arglist__10619){
var keyvals = cljs.core.seq(arglist__10619);
...
if(in$)
{{
var G__10620 = cljs.core.nnext(in$);
var G__10621 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(out,cljs.core.first(in$),cljs.core.second(in$));
in$ = G__10620;
out = G__10621;
continue;
}
...
priority_map_by.cljs$lang$applyTo = (function (arglist__10622){
var comparator = cljs.core.first(arglist__10622);
var keyvals = cljs.core.rest(arglist__10622);
